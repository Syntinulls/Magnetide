...
## Additional drift speed added per threat level (1-10).
...
## Additional heat build rate added per threat level (1-10).
...
## Additional cool-down delay (seconds) added per threat level (1-10).
...
@export var beam_frames: Array[Texture2D] = [
	preload("res://_project/ship/research_station/minigames/alignment_a/sprites/laser_1_frame_0.png"),
	preload("res://_project/ship/research_station/minigames/alignment_a/sprites/laser_1_frame_1.png"),
	preload("res://_project/ship/research_station/minigames/alignment_a/sprites/laser_1_frame_2.png"),
	preload("res://_project/ship/research_station/minigames/alignment_a/sprites/laser_1_frame_3.png"),
]
...
func _update_visuals(delta: float = 0.0) -> void:
	...
	# Editor hot-reload can leave member vars null on live instances; heal them.
