...
const DEFAULT_MINIGAME_SCENE: PackedScene = preload("res://_project/ship/research_station/minigames/alignment_a/alignment_a_minigame.tscn")
const OVERALL_BG: Texture2D = preload("res://_project/ship/research_station/sprites/overall_bg.png")
const OVERALL_PROGRESS: Texture2D = preload("res://_project/ship/research_station/sprites/overall_progress.png")
const OVERALL_BAR: Texture2D = preload("res://_project/ship/research_station/sprites/overall_bar.png")
## Research-point icon shown (tinted to the artifact's rarity) on the completion screen.
const RESEARCH_POINT_ICON: Texture2D = preload("res://_project/common/sprites/icon_research_point.png")
