...
const ALERT_YELLOW: Texture2D = preload("res://_project/level/magnet_minigame/sprites/alert_y.png")
const ALERT_ORANGE: Texture2D = preload("res://_project/level/magnet_minigame/sprites/alert_o.png")
const ALERT_RED: Texture2D = preload("res://_project/level/magnet_minigame/sprites/alert_r.png")
