...
func _ready() -> void:
	_bar_texture = preload("res://_project/level/magnet_minigame/sprites/bar.png")
	_cog_texture = preload("res://_project/level/magnet_minigame/sprites/cog.png")
	_marker_texture = preload("res://_project/level/magnet_minigame/sprites/marker_animation.png")
	_icon_neutral = preload("res://_project/level/magnet_minigame/sprites/icon_neutral.png")
	_icon_success = preload("res://_project/level/magnet_minigame/sprites/icon_success.png")
	_icon_failure = preload("res://_project/level/magnet_minigame/sprites/icon_failure.png")
	_icon_chevron = preload("res://_project/level/magnet_minigame/sprites/icon_chevron.png")
